	...
	return loading ? (
		...
		<div className="flex justify-center pb-16">
			<div className={cn("mx-auto flex flex-col items-center")}>
				<div className="mx-auto mb-8 mt-8 flex flex-row items-center">
					<h1 className="text-4xl font-bold text-foreground">Actors</h1>
					<button className="ml-8" onClick={() => setIsCreateModalOpen(true)}>
			...
			<CreateActorModal isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)} />
		</div>
	)
}
